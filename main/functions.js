...
// Message ID target
let message = grab_id('message')


// Assigning Variables to buttons ID within index.html
const animalsButton = grab_id('animals')
const gamesButton = grab_id('games')
const carsButton = grab_id('cars')
const programmingButton = grab_id('programming')
const randomButton = grab_id('random')
